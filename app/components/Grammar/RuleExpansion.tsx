...
function getSelectionData(rootElement: HTMLElement): SelectionData | null {
...
function restoreSelectionData(rootElement: HTMLElement, data: SelectionData): Range | null {
